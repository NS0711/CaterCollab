...
class RegisterPage extends StatelessWidget {
  ...
  Future<void> _registerUser(BuildContext context) async {
    final String url =
        'http://192.168.181.150/CaterCollab_AdminPanel/caterer_register_api.php';
...
void main() {
  runApp(MaterialApp(
    ...
    // routes: {
    //   'login': (context) => LoginPage(), // Replace LoginPage with your actual login page
    // },
    home: RegisterPage(),
  ));
}